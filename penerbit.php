      ...
      <a href="dashboard_siswa.php" class="navbar-brand"><p style="color: white"><b>Qualitiva.id</b></p></a>
        ...
        <div class="collapse navbar-collapse navHeaderCollapse">
          <ul class="nav navbar-nav navbar-left">
           ...
           <li> 
      <input type="text" class="form-control" placeholder="Cari Buku... "><li><button class="btn btn-default" type="button" style="background-color: yellow"  style="background-image:url(assets/images/ico-search-loop.png) inherit">Cari</button></li>
...
<?php kat(); ?> 
    ...
    <a href="#demo4" class="list-group-item list-group-item-success" data-toggle="collapse" data-parent="#MainMenu">Penerbit Buku</a>
